...
Este workshop busca proveer un conocimiento básico con varios aspectos de los sistemas de información geográfica (SIG), de tal manera que se entiendan el rango de los potenciales usos de los SIG en el trabajo aplicado y establecer bases adecuadas para incentivar estos. Por lo tanto, los objetivos de este workshop son:
...
-  Proveer las herramientas necesarias para manejar, analizar y visualizar SIG.
...
# 2. Manipulación de datos tipo vectores en R
